...
class _ApiService implements ApiService {
  _ApiService(
    ...
    baseUrl ??= 'https://preview20.meta-bytes.net/api/';
  }
  ...
  Future<StoreRecordsResponse> storeRecords(
      StoreRecordsResponse storeRecordsResponse) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(storeRecordsResponse.toJson());
    final _options = _setStreamType<StoreRecordsResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late StoreRecordsResponse _value;
    try {
      _value = StoreRecordsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
